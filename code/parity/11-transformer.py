# 11: Doesn't seem to work as well as 10-transformer.py
...
parser.add_argument("--batchSize", dest="batchSize", type=int, default=800)
parser.add_argument("--epochCount", dest="epochCount", type=int, default=10)
parser.add_argument("--n_layers", dest="n_layers", type=int, default=1)
parser.add_argument("--d_model_global", dest="d_model_global", type=int, default=128)
parser.add_argument("--d_ff_global", dest="d_ff_global", type=int, default=512)
...
model_opt = torch.optim.Adam(model.parameters(), lr=learning_rate, betas=(beta1, beta2), eps=eps)
