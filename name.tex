...
Take $k$. $k$ will have to be chosen in dependence of $c$ to make LLL work.
...
- the number of inputs without $> 2kc$ attached layer-2-heads could be asymptotically infinite, in which case we can just fix these bad inputs to a fixed value, and then can apply LLL afterwards, as $f \leq 2k^2c^2$ then.
