...
Then the number of pairs of inputs and layer-1 heads is $>0.9Cn \cdot 2cH/C > ncH$.
...
\end{equation}
we choose $n$, $k$ large enough. %so large that $B^{1/n} > 0.99$ and $(1-A)^H = (1-\frac{1}{2k^2c^2})^H > 0.99$.
