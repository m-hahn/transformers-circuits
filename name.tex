...
- transformers can do a fair amount of recursion

- actually, in some sense, even more than LSTMs
...
- we also show that transformer's ability to do recursion crucialy relies on the use of soft -- as opposed to hard -- attention
