...
\usepackage[acceptedWithA]{tacl2018v2} % ,copyedit,nohyperref
...
\maketitle
\begin{abstract}
The success of self-attention across natural languagr processing has sparked interest in their expressive capacity.
Theoretical and empirical work has found that they struggle with remarkbaly simple regular languages.
However, their precise capacity is not yet understood, and progress is blocked by unsolved problems in computational complexity.
Conditional on such an unsolved problem and with a realistic finite-precision restriction, we characterize the regular languages recognized by hard-attention transformers as t.
Extensive experiments support 
\end{abstract}
