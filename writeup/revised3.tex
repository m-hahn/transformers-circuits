...
First, they showcase mathematical techniques for analyzing the capabilities of self-attention, an architecture at the heart of recent and significant advances in NLP.
...
Second, our results suggest that language can be modeled well quantitatively with techniques that are theoretically too weak for for the formal languages typically assumed in theoretical linguistics.
...
Beyond general limitations of asymptotic analysis, a second possible reason for this phenomenon is that language, while having recursive structure, uses it in relatively restricted ways due to cognitive factors.
