...
Therefore, the results reported here may not constitute conclusive evidence for practical limitations of real-world NLP systems.
...
They showcase mathematical techniques for analyzing the capabilities of self-attention, an architecture at the heart of recent and significant advances in NLP.
...
Coupled with the empirical success of transformers, one interpretation of our results is therefore that natural language can be modeled well quantitatively with models that are asymptotically too weak for the formal languages typically assumed in theoretical linguistics.
