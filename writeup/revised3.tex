...
Nonetheless, the success of transformers across many NLP tasks suggests that many aspects of natural language can be modeled well quantitatively with models that are formally too weak for the formal languages typically assumed in theoretical linguistics.
