...
%These statements hold for any $k$ that is large enough .
...
The results presented here thus constitute the first theoretical confirmation of the intuition that models entirely built on self-attention mayhave restricted expressivity when compared to recurrent architectures~\cite{tran2018importance,dehghani2018universal,shen2018disan,chen2018best,hao2019modeling}.
