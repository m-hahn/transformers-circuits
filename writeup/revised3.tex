...
To this end, we now further modify $\rho_n'$ so that each layer-0 head has at most $\leq 2^c kH$ many $k$-depending layer-1 heads  such that some $((h,i),z)$ does not yet satisfy the Depth Reduction Lemma.
