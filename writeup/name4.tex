...
Indeed, transformers are not the only neural architecture in NLP to avoid or limit recurrence: Models such as feedforward language models (e.g., \citet{sundermeyer2013comparison}), convolutional networks (e.g.,~\citet{yin2017comparative}), and gated networks with reduced recurrence
\cite{lei2015semi,bradbury2016quasi,dauphin2017language,lei2017deriving,levy2018long,ostmeyer2019machine} all have shown good performance on tasks such as language modeling.
In future work, we intend to extend our theoretical analysis to such models, and investigate whether the success of recurrence-free models points to deeper statistical and formal properties of natural language.
