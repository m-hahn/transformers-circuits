...
\citet{korsky2019computational} showed, among other results, that arbitrary-precision RNNs can emulate pushdown automata.
...
We choose language modeling setting.

TODO unify. say we want to show that, for any transformer, there are values of $n$ large enough such that cross-entropy cannot be perfect (for distributions assiging nonzero probability to any)

We will also get results about classification.
...
Infinite-precision RNNs and LSTMs can model stacks \cite{tabor2000fractal,gruning2006stack,kirov2012processing,korsky2019computational} and thus are theoretically capable of modeling \textsc{2Dyck} and other deterministic context-free languages perfectly. % and \textsc{LogicalFormulas} perfectly.
