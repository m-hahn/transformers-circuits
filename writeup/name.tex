...
This means, if transformers cannot compute \textsc{Parity}, they cannot recognize any regular language that is not counter-free.
...
We have shown that, even with infinite precision, transformers cannot robustly non-counter-free regular languages, nor basic hierarchical structure.
