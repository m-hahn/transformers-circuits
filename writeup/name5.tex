...
In order for this to go through, we need to first show the following result.
TODO
...
Given any bound on the input length, it is certainly possible to construct a transformer .
(TODO)
