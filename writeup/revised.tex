...
TODO derive $H^L$ behavior

When considering the dimensions of the extremely large state-of-the-art systems (TODO GPT-2 how many layers), such bounds are clearly beyond the scale relevant to real-world NLP.
