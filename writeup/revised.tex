...
This is visualized in an example in Figure~\ref{fig:selecting}.
...
\begin{figure}[ht]
	...
	(b) We select $k = 2$ Layer 0 activations, marked in blue and green. For each of these, there is at least one (in fact, two here) input bits that feed into this one and no other selected activation, also marked in blue and green, respectively.}
	\label{fig:selecting}
\end{figure}
