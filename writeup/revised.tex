...
\paragraph{Scope of Results}
mention what kinds of architectures soft attention results are applicable to

soft attention results most crucially rely on the fact that the number of layers is bounded independently of the input size
