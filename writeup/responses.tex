...
\response{... We have expanded the proof of Theorem 7. Reviewer B had noted that it was too brief, so we now explain in more detail the argument for \textsc{Parity} and \textsc{2Dyck}. We weakened the statement of the theorem (suboptimal cross-entropy, instead of unigram baseline level, for 2Dyck), in order to be able to present the argument in more sufficient detail.}
