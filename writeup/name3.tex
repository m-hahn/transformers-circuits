...
\title{Theoretical Limitations of Self-Attention in Neural Sequence Models, VERSION3 with alternative hard attention proof}
...
\section{Alternative Proof for Soft Attention}\label{sec:soft}
